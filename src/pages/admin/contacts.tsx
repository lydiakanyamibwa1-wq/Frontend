...
const Messages = () => {
  const [messages, setMessages] = useState<Message[]>([
    { id: "1", sender: "Lydia", email: "lydia@mail.com", message: "I need help with my order." },
    { id: "2", sender: "Yvan", email: "yvan@mail.com", message: "how long does it take to deliver?" },
    { id: "3", sender: "Julie", email: "julie@mail.com", message: "How much for shipping." },
  ]);
